      ...
      <section className="landing-container">
        <div className="content-landing">
          ...
          <div className="landing-descricao">
            <p>
              Bem-vindo à nossa plataforma inMind, onde cuidar da sua saúde
              mental é tão simples quanto alguns cliques. Estamos orgulhosos de
              apresentar um ambiente virtual intuitivo e seguro, desenvolvido
              para proporcionar uma experiência sem complicações. Ao criar um
              perfil, você entra em um mundo de possibilidades para o seu
              bem-estar emocional. Navegue por uma lista de psicólogos
              credenciados, explorando suas especializações, disponibilidade e
              preços. Agende consultas de maneira conveniente e realize suas
              sessões remotas via Google Meet, garantindo a flexibilidade que
              você precisa. Avalie a qualidade das sessões e compartilhe suas
              experiências, contribuindo para a transparência e incentivando a
              melhoria constante dos serviços. Seu feedback é crucial para nós,
              pois acreditamos na importância de uma comunidade que cresce
              junto. Cadastre-se na plataforma, fornecendo informações
              detalhadas sobre suas especializações, horários disponíveis e
              valores. Junte-se a nós na jornada em direção ao bem-estar
              emocional, porque acreditamos que todos merecem apoio quando
              precisam.
            </p>
          ...
          <div className="cards-container">
            ...
            >
              <div className="card">
                ...
                <p>
                  ...
                  repentina, inesperada e de certa forma inexplicável de crises
                  de ansiedade aguda ...
                </p>
              </div>
            </a>
            ...
            >
              <div className="card">
                ...
                <p>
                  ...
                  alterações na atividade cerebral que levam a um quadro
                  duradouro de tristeza ou perda de interesse por atividades
                  corriqueiras. Segundo a ...
                </p>
              </div>
            </a>
            <a
            ...
            >
              <div className="card">
                ...
                <h4>Ansiedade</h4>
                <p>
                  O Transtorno de ansiedade é um distúrbio psiquiátrico em que
                  há excesso de apreensão e expectativa de alguém em relação a
            ...
            >
              <div className="card">
                ...
                <p>
                  O Transtorno Afetivo Bipolar é caracterizado por períodos em
                  que se alternam sintomas do pólo depressivo com aqueles do
                  polo da euforia. “Há aqueles períodos caracteriza...
                </p>
              </div>
            </a>
          </div>
